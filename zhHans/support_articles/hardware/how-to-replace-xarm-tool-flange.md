...
## 1. 先将手臂回到零点位置并且标记手臂最后一个关节

在更换末端法兰过程中会丢失并且重置手臂最后一个关节的零点位置。在拆卸任何部件之前，需要标记在零点位置时末端法兰 IO 接口与手臂对准位置（应与带有橡胶“UF”标志的在同一侧），以防止此位置丢失。

## 2. 按下急停按钮、关闭电源并拔下手臂电源线

## 3. 拆卸手臂最后一个关节的银色外壳

外壳上的螺栓被贴纸遮盖。可以用镊子将贴纸揭开后再拧下螺丝，或者直接用内六角扳手戳破贴纸拧下螺丝并拆下外壳
...
剪断连接到红色和蓝色电线上的蓝色压接端子，拔下通信端口，若有需要，刮掉黄色胶水

![](./assets/flange_step5.jpg)

## 6. 移除末端工具法兰

拧下固定法兰的螺栓，注意两侧中间的螺栓有三个垫圈（2 薄1 厚），而外侧的螺栓只有一个垫圈
...
拧入金属回旋镖状部件以固定电线。在螺钉上涂上黄色胶水

## 11. 对齐关节螺栓和工具头部

如步骤 7 所述，将螺栓头对齐在金属凹槽，避免碰撞到电容

![](./assets/flange_step7_11.png)

## 12. 将法兰固定到关节上

在螺栓上涂上蓝色乐泰胶，并在中间的螺栓上使用三个垫圈，在外侧的螺栓上使用一个垫圈，将法兰固定到接头。确保使用正确的较长螺栓。
...
红色为+24V，蓝色为GND。剥去约 1cm 的线皮以便压接。最佳效果是确保金属线从蓝色压接端子中露出，靠近螺栓的圆孔。将它们固定到电路板上。
...
取下橡胶“UF”标志，在将关节与连杆对齐的同时将电线穿过。注意接口与步骤1中标记的零点位置对齐。
...
在螺栓上轻轻涂抹蓝色乐泰胶，并将关节螺栓固定到位。再次确认末端法兰 IO 接口与先前标记的零点位置对齐——应在带有“UF”橡胶标志的一侧。

![](./assets/flange_step18.jpg)

## 19. 重新安装关节银色外壳前，重置最后一个关节的零点位置
