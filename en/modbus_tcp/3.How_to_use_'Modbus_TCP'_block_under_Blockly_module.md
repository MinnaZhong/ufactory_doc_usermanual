...
2.Send the command to write '12 34'  to the address '01 A0', it will let the arm go to [400, 0, 120.7, 180, 0, 0].

```
00 01 00 00 00 06 01 06 01 A0 12 34
```

3.Send the command to write '00 01' to the address '01 00', it will let the arm go to [300, 200, 120.7, 180, 0, 0].
