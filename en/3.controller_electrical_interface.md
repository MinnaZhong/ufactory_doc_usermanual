...
#### Power Connector
![](assets/controller_4.jpg)
| 4-Pin Power Connector |             |     |              |
| -------------------------- | ----------- | --- | ------------ |
| Pin Sequence | Signal | Pin Sequence | Signal |
| 1                          | +24V(Power)         | 3   | PE          |
| 2                          | 0V(GND) | 4   | Not Connected |

#### Enable Switch Connector
![](assets/controller_6.jpg)
| 8-Pin Enable Switch |             |              |               |
| ------------------- | ----------- | ------------ | ------------- |
| Pin Sequence        | Signal      | Pin Sequence | Signal        |
| 1                   | EN | 5            | SI3           |
...
**Note:** 
* When using an external AC–DC power supply, a supply voltage of 36 V or higher is recommended.
* Insufficient input power may result in joint undervoltage errors, failure to enable the robotic arm, communication errors, and repeated controller resets.

### 3.3.3 Definition of Industrial Connector
Refer to [3.2.3 Definition of Industrial Connector](#323-definition-of-industrial-connector)
...
The id of our controller is 11. 
...
#### RS485 Slave
* PIN: L_A, L_B, 24V, GND;
* [Check Register Definitions.](https://docs.api.ufactory.cc/modbus_rtu/modbusrtu_manual.html#_3-4-register-mapping-examples)
...
5. Enter 192.168.1.111:18333 in a web browser to connect to the robotic arm.

#### Method 2: IP Reset Key
![](assets/resetip_1.jpg)
1. Turn on the power of the xArm controller and ensure it starts up properly.
2. Press the emergency stop button.
3. Use a PIN to press and hold the IP reset key for more than 5 seconds. **Release it after you hear the buzzer sound**,indicating that the controller’s IP has been successfully reset. The reset IP address is: 192.168.1.111.
4. The controller will automatically restart. Wait until the startup process is complete.
5. Enter 192.168.1.111:18333 in a web browser to connect to the robotic arm.
